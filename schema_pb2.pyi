...
class BackupManga(_message.Message):
    __slots__ = ("source", "url", "title", "artist", "author", "description", "genre", "status", "thumbnailUrl", "dateAdded", "viewer", "chapters", "categories", "tracking", "favorite", "chapterFlags", "viewer_flags", "history", "updateStrategy", "lastModifiedAt", "favoriteModifiedAt", "excludedScanlators", "version")
